                        ...
                        <div class="card card-transparent shadow-none d-flex justify-content-center mb-0 auth-card">
                           <div class="card-body">
                              <a href="<?php echo base_url(); ?>/dashboard/index.html" class="navbar-brand d-flex align-items-center mb-3">
                                 ...
                                 <img src="<?php echo base_url(); ?>/assets/images/icon.png" style="width: 30%; height: auto;">

                                 <!--logo End-->                            
                                                               
                                 
                                 <h1 class="logo-title ms-3">SolEnergy</h1>
                              </a>
                                 ...
                                 <div class="row">
                                    <div class="col-lg-12">
                                       <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" id="usuario" name="usuario" aria-describedby="usuario" placeholder=" ">
                                       </div>
                                    </div>
                                    <div class="col-lg-12">
                                       <div class="form-group">
