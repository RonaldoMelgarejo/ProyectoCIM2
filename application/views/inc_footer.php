      ...
      <footer class="footer">
          <div class="footer-body">
              <ul class="left-panel list-inline mb-0 p-0">
                  <li class="list-inline-item"> <!-- <a href="<?php echo base_url(); ?>/dashboard/extra/terms-of-service.html"> --> Condiciones de uso</a></li>
                  <li class="list-inline-item"> <!-- <a href="<?php echo base_url(); ?>/dashboard/extra/privacy-policy.html"> --> política de privacidad</a></li>
              </ul>
              <div class="right-panel">
                  ©<script>document.write(new Date().getFullYear())</script> <!-- Hope UI, hecha con 
                  <span class="">
                  ...
                  </span> por <a href="https://iqonic.design/">Diseño IQONIC</a>. -->
              </div>
          </div>
      </footer>
      <!-- Footer Section End -->    
